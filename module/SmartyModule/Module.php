...
// 		$obj=new \Zend\Mvc\I18n\Translator();
// 		\SmartyBC::register_modifier('translate', array($obj, 'translate' ));
		$this->setupView($e);
	} 
// 	public function translate($word){
// 		\SmartyBC::registerPlugin('modifier','_translate', array($this,'translate'));
// 		$this->translator = $this->getApplication()->getServiceManager()->get('translator');
